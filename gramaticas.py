...
class bienvenida2():
    def __init__(self):
        self.gramatica = []
        self.error = []
        self.wing = tk.Toplevel()
        self.wing.resizable(True,False) # Redimensionar la ventana
        self.wing.title('..::ADF::..') # Titulo de la ventana
        self.wing.geometry('1000x700') # Tamaño de la ventana
        self.Centrar2(self.wing, 1000, 700) # Centrar la ventana
        self.wing.config(bg='#102027')
    ...
    def Ventana2(self):
        ...
        Label(self.wing, text="...:::...Módulo de Gramaticas...:::...", font=('Times New Roman',15), fg='#000000', bg='#FFAC33', width=52).place(x=200, y=20)
        Button(self.wing, text="Cargar Archivo",command=self.cargar, font=('Times New Roman',15), fg='#000000', bg='#FFAC33', width=15).place(x=425, y=240)
        Button(self.wing, text="Información General",command=opcion1, font=('Times New Roman',15), fg='#000000', bg='#FFAC33', width=15).place(x=425, y=280)
        Button(self.wing, text="Árbol de Derivación",command=Cargar_Gramatica, font=('Times New Roman',15), fg='#000000', bg='#FFAC33', width=15).place(x=425, y=320)
        Button(self.wing, text="Atrás",command=lambda:self.wing.destroy(), font=('Times New Roman',15), fg='#000000', bg='#FFAC33', width=15).place(x=425, y=360)
